    ...
    <div className="relative min-h-screen bg-[#141514] text-[#EFECE6] py-32 sm:py-40 lg:py-48 overflow-hidden">
      ...
      <div className="site-container max-w-4xl relative z-10 flex flex-col gap-16 sm:gap-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            <div className="w-full max-w-[380px] aspect-[1.6/1] bg-gradient-to-br from-[#242624] via-[#1A1B1A] to-[#121312] border-2 border-[#94BA26]/40 p-6 sm:p-7 flex flex-col justify-between rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_30px_rgba(148,186,38,0.15)] relative overflow-hidden group">
              ...
              <div className="text-center my-auto py-2 relative z-10">
                <span
                  className="text-4xl sm:text-5xl text-white font-light tracking-tight block"
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}
                >
                  {displayAmount}
                </span>
          ...
          <motion.div
            ...
            className="lg:col-span-7 luxury-card p-7 sm:p-10"
          >
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="text-2xl sm:text-3xl text-white font-light mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                      ...
                      {amounts.map((amt) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex-1 min-w-[70px] py-3 px-3.5 rounded-lg text-xs font-semibold tracking-wider transition-all duration-300 border shadow-sm ${
                              isSelected
