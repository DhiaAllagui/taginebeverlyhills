...
<head>
  ...
  <style>
    ...
    .notes-box { background: rgba(255, 255, 255, 0.03); border-left: 3px solid #94BA26; padding: 14px 16px; border-radius: 4px; margin-top: 12px; font-size: 13px; color: #EFECE6; }
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <table class="grid">
        ...
        <tr><td class="label">Guest Phone</td><td class="val"><a href="tel:${phone}" style="color: #94BA26; text-decoration: none;">${phone}</a></td></tr>
        <tr><td class="label">Guest Email</td><td class="val"><a href="mailto:${email}" style="color: #94BA26; text-decoration: none;">${email}</a></td></tr>
      </table>

      ${
        notes
          ? `<div class="label" style="font-size: 12px; color: #9C9B94; margin-bottom: 6px;">Special Guest Requests / Dietary:</div>
